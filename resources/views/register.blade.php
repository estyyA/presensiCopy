          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="mb-3">
                ...
                <input type="text" name="divisi" id="divisi" class="form-control" placeholder="Divisi" required>
              </div>
              <div class="mb-3">
                <label for="id_divisi" class="form-label">ID Divisi</label>
                <input type="text" name="id_divisi" id="id_divisi" class="form-control" required>
              </div>
              <div class="mb-3">
