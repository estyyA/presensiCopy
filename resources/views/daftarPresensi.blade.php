    ...
    @section('content')
        ...
        <div class="card shadow-sm border-0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @switch(strtolower($p->status))
                                            ...
                                            @default
                                                <span class="badge badge-danger px-3 py-1">Alpha</span>
                                        @endswitch
                                    </td>
                                    <td>
                                        <button type="button" class="btn btn-warning btn-sm btn-edit-presensi"
                                            title="Edit" data-presen='@json($p)'>
                                            <i class="fa fa-edit"></i>
                                        </button>
                                        <form action="{{ route('presensi.destroy', $p->id_presen) }}" method="POST"
                                    ...
                                    <td>
                                        @if ($p->surat)
                                            <a href="{{ asset('storage/' . $p->surat) }}" target="_blank"
            ...
            <div class="modal fade" id="editPresensiModal" tabindex="-1" role="dialog" aria-labelledby="editPresensiLabel"
                aria-hidden="true">
        ...
        @push('styles')
            <style>
                ...
                .btn-purple:hover {
                    background-color: #59309a !important;
                }
