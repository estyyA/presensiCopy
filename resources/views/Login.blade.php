...
<head>
    ...
    <style>
        ...
        .form-control:focus {
            border-color: #3f71dc;
            box-shadow: 0 0 0 0.2rem rgba(63, 113, 220, 0.25);
        }
    ...
    <div class="login-container">
        ...
        <div class="login-card">
            ...
            <form action="{{ route('login.process') }}" method="POST">
                ...
                <button type="submit" class="btn btn-login w-100 mb-2"><i
                        class="bi bi-box-arrow-in-right me-2"></i>Login</button>
                <div class="text-center mt-3">
                    <small>Belum punya akun? <a href="{{ url('/register') }}"
                            class="register fw-bold">Register</a></small>
                </div>
            </form>
        </div>
    </div>
