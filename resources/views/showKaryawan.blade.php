...
@section('content')
    <div class="container mt-5">
        <div class="card shadow-lg border-0 rounded-4 overflow-hidden">
            <!-- Header -->
            <div class="card-header text-white py-3" style="background: linear-gradient(135deg, #4facfe, #0e3132);">
                    ...
                    <div class="col-md-8">
                        <table class="table table-borderless align-middle">
                            ...
                            <tr>
                                ...
                                <td>{{ $karyawan->tgl_lahir ? \Carbon\Carbon::parse($karyawan->tgl_lahir)->format('d-m-Y') : '-' }}
                                </td>
                            </tr>
                            <tr>
